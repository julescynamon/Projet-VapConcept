...
async function convertExcelToJSON(excelFile) {
  ...
  // je boucle sur mon tableau d'objet pour réassigner la keys field5 en unitPrice
  for (let i = 0; i < filteredTable.length; i++) {
    const currentLine = filteredTable[i];
    const object = {};
  ...
  // je boucle sur mon tableau d'objet pour supprimer la keys field3
  for (let i = 0; i < filteredTable.length; i++) {
    const currentLine = filteredTable[i];
    const object = {};
  ...
  // je boucle sur mon tableau d'objet pour réassigner la keys field4 en field3
  for (let i = 0; i < filteredTable.length; i++) {
    const currentLine = filteredTable[i];
    const object = {};
  ...
  // je boucle sur mon tableau d'objet pour réassigner la keys field6 en field4
  for (let i = 0; i < filteredTable.length; i++) {
    const currentLine = filteredTable[i];
    const object = {};
